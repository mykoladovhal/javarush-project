package ua.javarush.task.task24.task2412;
...
public class Solution {
    ...
    public static void printStocks(List<Stock> stocks, Date actualDate) {
        ...
        // ОШИБКА БЫЛА ЗДЕСЬ: массив testFormats должен иметь 7 элементов (индексы 0-6),
        // потому что MessageFormat использует {5} и {6} - нужно добавить null для индексов 0-4
