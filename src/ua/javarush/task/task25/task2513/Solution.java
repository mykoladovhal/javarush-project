package ua.javarush.task.task25.task2513;
...
public class Solution {
    ...
    public static synchronized void moveMoney(Account from, Account to, int amount) {
        ...
        System.out.printf("Транзакція №%d: списання $%d з рахунку №%d. Баланс: %d.%n", transactionNumber, amount, from.getNumber(), from.getBalance());
        from.setBalance(from.getBalance() - amount);
        Thread.yield();
        System.out.printf("Транзакція №%d: зарахування $%d на рахунок №%d. Баланс: %d.%n", transactionNumber, amount, to.getNumber(), to.getBalance());
    ...
    static class Account {
        ...
        public void checkBalance() {
            System.out.println(this.number + ": перевірка...");
