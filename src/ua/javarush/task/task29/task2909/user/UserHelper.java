package ua.javarush.task.task29.task2909.user;
...
public class UserHelper {
    ...
    public void printUsers() {
        System.out.println("Ім'я: " + userAnya.getName());
        System.out.println("Прізвище: " + userAnya.getSurname());
        printAdditionalInfo(userAnya);

        System.out.println("Ім'я: " + userRoma.getName());
        System.out.println("Прізвище: " + userRoma.getSurname());
        printAdditionalInfo(userRoma);
    }

    public void printAdditionalInfo(User user) {
        if (ageLessThan16(user))
            System.out.println("Користувач молодше 16 років");
        else
            System.out.println("Користувач старше 16 років");
    }
