package ua.javarush.task.task29.task2909.human;
...
public class StudentsDataBase {
    ...
    public static void printInfoAboutStudent(String name, Student student) {
        System.out.println("Ім'я: " + name + " Вік: " + student.getAge());
    }
        ...
        for (int i = 0; i < students.size(); i++) {
            if (!found) {
                if (students.get(i).getName().equals("Dima")) {
                    System.out.println("Студент Dima є в базі.");
                    found = true;
                }

                if (students.get(i).getName().equals("Sasha")) {
                    System.out.println("Студент Sasha є в базі.");
                    found = true;
                }
            }
        }
